...
KEYMAPS(
  ...
  (Key_Escape,          Key_1, Key_2, Key_3, Key_4, Key_5, Key_LEDEffectNext,
   ...
   Key_LeftShift, Key_Z, Key_X, Key_C, Key_V, Key_B, Key_Enter4,
   ...
   LGUI(LSHIFT(Key_Z)),  Key_N, Key_M, Key_Comma, Key_Period,    Key_Slash,     Key_Minus,
   Key_PageUp, Key_LeftAlt, Key_Spacebar, Key_RightControl,
   ShiftToLayer(FUNCTION)),
